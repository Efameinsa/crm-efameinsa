 ...
 *
 * Es lo que la cotización imprime en el bloque del cliente, y lo que
 * contabilidad necesita para que cotización, orden de compra, guía y factura
 * cuadren. Un tercio de las cuentas está sin documento porque el contacto
 * entra por la web con el nombre de una persona y nada más; el RUC aparece
 * después, hablando, y hasta el 24-08 no había dónde anotarlo.
 *
    ...
    <div className="space-y-3 rounded-lg border border-primary/40 bg-primary/5 p-3">
      <div className="space-y-1.5">
        ...
        <p className="text-[11px] text-muted-foreground">
          Escríbala como debe salir en la factura. Es la que se imprime en la cotización.
        </p>
      </div>
