-- 21-09-2026: la regla «un expediente por cliente» (0141, Carlos 01-09)
-- excluía los expedientes que vinieron del Excel aunque tuvieran trabajo real
-- en el CRM. Dance Sologuren: 20 gestiones y 3 cotizaciones sobre uno del
-- Excel, y la derivación de hoy abrió un gemelo vacío; Ariana no veía sus
-- cotizaciones. Se parcha la definición viva de asignar_lead.
