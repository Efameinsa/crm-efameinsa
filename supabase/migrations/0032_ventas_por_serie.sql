-- ============================================================
-- CRM EFAMEINSA · Migración 0032 · Ventas por empresa (EFAMEINSA / OPEN)
-- ============================================================
-- Pedido del ing. Carlos (19-08 noche): "¿cuánto ha vendido este mes en
-- Open y cuánto en Efameinsa? Eso es determinante" — la proyección de
-- importaciones (99,9 % entran por Open) y la gestión de cobranza dependen
-- de saber el volumen por razón social. El cotizador ya registra la serie
-- por cotización/venta; esta migración la lleva a los reportes:
--   · kpis.ventas_serie: monto y nº de ventas por EFAMEINSA / OPEN /
--     sin empresa (las históricas del Excel no traían razón social — se
--     rellenarán cuando gerencia entregue los consolidados, que sí la
--     separan por secciones).
--   · serie_mensual: cada mes trae también efameinsa_usd / open_usd /
--     sin_serie_usd para el gráfico de barras APILADAS que pidió Carlos.
-- Recrea resumen_gerencia completa (base: 0031).
