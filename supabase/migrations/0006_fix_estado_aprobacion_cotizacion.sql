-- ============================================================
-- CRM EFAMEINSA · Migración 0006 · Fix: crear_cotizacion() sin cast
-- ============================================================
-- Mismo patrón de bug que la migración 0003: un CASE con solo literales de
-- texto resuelve a `text` y Postgres no lo castea solo al asignarlo a una
-- columna enum (`estado_aprobacion`) dentro de un UPDATE. Detectado al
-- verificar B4 de punta a punta: CUALQUIER cotización fallaba al crearse.
