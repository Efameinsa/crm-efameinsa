-- ============================================================
-- CRM EFAMEINSA · Migración 0085 · La agenda del reporte cuenta solo el CRM
-- ============================================================
-- Visto el 25-08 en el reporte de Katerine: la tarjeta Agenda decía «6196
-- vencidas» — contaba las ~21.000 oportunidades del archivo histórico
-- (origen historico_excel), que no son agenda de nadie. Mismo criterio que la
-- 0023 («embudo solo CRM»): la agenda del día son las oportunidades del CRM.
