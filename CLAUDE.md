...
2. **Precios:** listas de precios por producto. Semi-industrial: 3 niveles (**óptimo / medio / deseado**). Industrial: lista base. El vendedor se auto-aprueba dentro de la lista; **por debajo de lista → aprobación de gerencia** (estado `pendiente_gerencia` en la cotización). ⚠️ Confirmar con gerencia cuál nivel es el piso permitido al vendedor.
   - **EL CATÁLOGO Y SUS PRECIOS LOS GESTIONA LESLY EN EL CRM (regla nueva, Santos 10-09-2026):** *«ya dejemos de trabajar con el maestro; de ahora en adelante Lesly es la que va a gestionar, no necesitas tomar la referencia del maestro»*. Lo que está cargado en el CRM es lo bueno — ficha, precio, stock, activo/retirado y las tres imágenes de la hoja salen de su pantalla de operaciones. **No se corren los cargadores del maestro** (tienen portón: `scripts/maestro-retirado.mjs`): el que alinea RETIRA todo lo que el Excel no lista y ya se llevó puestos equipos con ficha y precio (SECU75E/E2/E3, 28-08). Deroga la regla del 25-08 —«la única fuente de precio es el maestro de Lesly, columna VALOR DE VENTA»— y la del 27-08 —«todo lo demás será retirado»—, que explican de dónde salieron los precios hoy cargados. El stock semanal de Importaciones (`cargar-stock-semanal.mjs`, ing. Carlos 01-09) NO es el maestro y sigue corriendo.
   - **Las fichas .docx de `V:\` NO son fuente de precio.** De las 65, solo 4 traen una cifra escrita; el resto son plantillas con el precio en blanco (`US$ + I.G.V.`, `00,000.00`). Donde sí traen número coinciden con el maestro, salvo la **SECA758**, cuya ficha de 2023 dice 5,300 contra los 8,999 que quedaron cargados. Ante una diferencia así **manda lo que está en el CRM**; si hay duda de fondo se le pregunta a Lesly, y nunca se elige la cifra más baja.
